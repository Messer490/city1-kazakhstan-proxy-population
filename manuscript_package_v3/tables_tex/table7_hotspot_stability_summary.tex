...
\centering
\small
\caption{Hotspot stability summary by class. Stable classes retain substantially higher mean stability metrics than caution-heavy classes across the frozen city set. Class labels are abbreviated for readability.}
\label{tab:hotspot-stability}
