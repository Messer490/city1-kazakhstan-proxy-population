...
\centering
\scriptsize
\caption{District and external evidence retained in the frozen paper-facing package. These layers are informative as context and limitation evidence, but they are not strong enough to support truth-style claims.}
\label{tab:district-external}
