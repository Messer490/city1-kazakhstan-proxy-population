...
\centering
\scriptsize
\caption{Error-uncertainty alignment summary from the frozen paper-facing package. Positive width-error correlations are retained across all shown city/protocol combinations, whereas relative-uncertainty and confidence ordering remain mixed.}
\label{tab:error-alignment}
