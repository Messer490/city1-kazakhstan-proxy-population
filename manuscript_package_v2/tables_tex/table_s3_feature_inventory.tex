...
\begin{longtable}{L{0.15\textwidth} L{0.22\textwidth} L{0.11\textwidth} L{0.40\textwidth}}
\caption{Frozen City1 v2 feature inventory grouped by family. The weak-target column indicates whether a feature participates directly in the default weak-label weighting scheme.}\label{tab:s3_feature_inventory}\\
\toprule
...
Built form & Building\_With\_Levels\_Count & no & number of buildings with observed level tags \\
...
POI/services & Parks\_Shops\_Count & yes & combined count of parks and shop features used in the frozen stack \\
