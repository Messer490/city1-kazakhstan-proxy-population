...
\centering
\small
\caption{Frozen weak-label weights used in the default City1 v2 proxy score. Only features available in a given city contribute to the weighted sum.}
\label{tab:s4_weak_weights}
\begin{tabular}{lll}
\toprule
