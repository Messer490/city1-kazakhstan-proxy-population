...
Tool-grounded interpretation pathway & Future extension & future tool-grounded LLM layer using calibrated surface, intervals, hotspot classes, and limitations & not evaluated in current paper & future work only, not a completed result \\
\bottomrule
\end{tabular}
\end{table}
