...
\centering
\small
\caption{P10--P90 interval coverage against retained proxy targets. LOCO-like results come from the bounded local proxy-check setting; inference-only proxy checks come from the four-city output package.}
\label{tab:interval-coverage-unified}
