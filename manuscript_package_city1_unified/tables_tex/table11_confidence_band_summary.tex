...
\centering
\small
\caption{Confidence-band summary. Shares are percentages of city cells, and priority share is the proportion of cells in each band that fall into one of the hotspot-priority classes.}
\label{tab:confidence-bands-unified}
