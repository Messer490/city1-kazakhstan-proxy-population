...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Build the frozen City1 v3 Phase 7 paper-facing evidence package from Phase 3-6 outputs."
    )
    parser.add_argument(
        "--run-id",
        type=str,
...
def main() -> None:
    ...
    print("City1 v3 Phase 7 paper-facing package completed.")
